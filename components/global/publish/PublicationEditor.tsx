...
import { FORMAT_META, PublicationFormat } from '@/lib/publishTypes'
...
export function PublicationEditor({ authorId, format, publicationId }: Props) {
  ...
  const {
    ...
    updateChapterTitle, addChapter, deleteChapter,
      ...
      <main style={{
        ...
        <input
          ...
          style={{
            ...
            outline: 'none', color: TEXT, fontSize: 28, fontWeight: 800,
