  ...
  return <footer className={styles.footer}>
    ...
    <div className={styles.footerInner}>
      <div className={styles.footerTop}>
        ...
        <div><h2 className={styles.columnTitle}>Families</h2><div className={styles.linkList}><Link href="/product">Parent experience</Link><Link href="/blog">Education news & guides</Link><Link href="/pathways">Future choices</Link><Link href="/pathways/schools">School discovery</Link><TrackedLink href="/login/global?role=parent" event="public_auth_signin">Parent sign in</TrackedLink></div></div>
