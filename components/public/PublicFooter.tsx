  ...
  return <footer className={styles.footer}>
    ...
    <div className={styles.footerInner}>
      <div className={styles.footerTop}>
        ...
        <div><h2 className={styles.columnTitle}>VibeSchool</h2><div className={styles.linkList}><Link href="/about">About</Link><Link href="/institutions">Institutions & government</Link><Link href="/evidence">Evidence & status</Link><Link href="/trust">Trust Centre</Link><Link href="/contact">Contact</Link><Link href="/careers">Careers</Link></div></div>
      </div>
      <div className={styles.footerBottom}><span>© 2026 VibeSchool · Kenya</span><div className={styles.legalLinks}><Link href="/evidence">Evidence</Link><Link href="/trust">Trust</Link><Link href="/legal/privacy">Privacy</Link><Link href="/legal/terms">Terms</Link><Link href="/legal/aup">Acceptable Use</Link></div></div>
    </div>
  </footer>
}
