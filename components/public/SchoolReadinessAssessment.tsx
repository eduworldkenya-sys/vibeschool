...
export function SchoolReadinessAssessment(){
  ...
  return <section aria-labelledby="school-readiness-assessment-title" style={{padding:'84px max(18px,calc((100vw - 1120px)/2))',background:'#f0f1f8'}}>
    <div style={{maxWidth:760}}><p style={{fontSize:11,letterSpacing:'.16em',fontWeight:850,color:'#725815'}}>SCHOOL READINESS CHECK</p><h2 id="school-readiness-assessment-title" style={{fontSize:'clamp(32px,4.7vw,52px)',lineHeight:1.06,letterSpacing:'-.04em',margin:'10px 0 16px'}}>How connected is learning in your school?</h2><p style={{color:'#626575',lineHeight:1.7}}>Answer eight operational questions. Your result and prescription stay in this browser session. This is a self-assessment and planning aid, not an external audit or certification; use the prescription to decide what to test first.</p></div>
