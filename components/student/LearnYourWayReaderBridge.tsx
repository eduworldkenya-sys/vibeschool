...
const button: CSSProperties = {
  position:'fixed', right:16, bottom:'calc(20px + env(safe-area-inset-bottom))', zIndex:9990,
  display:'flex', alignItems:'center', gap:9, border:'1px solid rgba(255,255,255,.18)', borderRadius:16,
  padding:'10px 13px', background:'#5b4ee8', color:'#fff', boxShadow:'0 14px 36px rgba(31,25,104,.36)',
