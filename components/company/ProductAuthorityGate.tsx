...
import { evaluateCompanyPolicy, type PolicyEvaluation } from "@/lib/company/config"
...
export default function ProductAuthorityGate({ productKey, policyKey, children, label = "This VibeSchool service" }: Props) {
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "#0F0F1A", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
