...
export function Btn({ children, variant = "primary", onClick, small, style = {}, disabled }: BtnProps) {
...
export function Avatar({ initials, size = 36, bg = C.accent, color = "#fff", style = {}, onClick }: AvatarProps) {
  return (
    <div
      onClick={onClick}
      style={{
