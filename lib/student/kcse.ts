...
export const recordKcsePracticeAnswer = (questionId: string, selectedIndex: number, responseMs: number | null, sessionId: string | null = null) => call<{ correct: boolean; correct_index: number; explanation: string | null; next_retest_days: number }>('student_record_vibelearn_practice_answer', { p_exam_question_id: questionId, p_selected_index: selectedIndex, p_response_ms: responseMs, p_session_id: sessionId })
