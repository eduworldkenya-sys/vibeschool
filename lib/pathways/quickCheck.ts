...
export type QuickCheckChoice = { label: string; scores: Partial<QuickCheckScores> }
export type QuickCheckQuestion = { id: string; prompt: string; choices: QuickCheckChoice[] }

export const QUICK_CHECK_RULE_VERSION = 'pathways-quick-v1'
export const QUICK_CHECK_STORAGE_KEY = 'vs_pathways_quick_check_v1'

export const QUICK_CHECK_PATHWAYS: Record<PathwayKey, { name: string; summary: string; canonicalSlug: string }> = {
  stem: { name: 'STEM', summary: 'Science, technology, engineering and mathematics.', canonicalSlug: 'stem' },
  social: { name: 'Social Sciences', summary: 'People, society, languages, humanities and business-oriented exploration.', canonicalSlug: 'social-sciences' },
  arts: { name: 'Arts & Sports Science', summary: 'Creative, performance, visual arts and sports-oriented exploration.', canonicalSlug: 'arts-and-sports-science' },
}
