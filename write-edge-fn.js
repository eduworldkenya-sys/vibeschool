...
const code = `import { serve } from "https://deno.land/std@0.208.0/http/server.ts"
...
fs.mkdirSync('supabase/functions/generate-lesson-plan', { recursive: true })
fs.writeFileSync('supabase/functions/generate-lesson-plan/index.ts', code)
console.log('generate-lesson-plan/index.ts written — G1 G4 G7 applied')
