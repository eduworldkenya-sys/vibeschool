...
export default function HQLayout({ children }: { children: React.ReactNode }) {
  ...
  return <>
    ...
    {children}
    <style jsx global>{`
      /* The current shell already owns navigation structure. These selectors only
         replace its destination-only search triggers with the owner-gated company
         search from PR #364, preserving the newer responsive/mobile shell. */
