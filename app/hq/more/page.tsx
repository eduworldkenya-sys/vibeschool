...
const domains = [
  ["Product", "/hq/analytics", "Schools, users, adoption, engagement and learning intelligence."],
...
export default function HQMorePage(){
  return <HQPage title="More" description="Company operating domains not pinned to the mobile command bar.">
