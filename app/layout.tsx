  ...
  '@graph':[
    {
      ...
      logo:{'@type':'ImageObject',url:'https://www.vibeschool.co.ke/icons/vibeschool-logo.png'},
      ...
      knowsAbout:['Kenya education','CBC','CBE','KCSE','KJSEA','KPSEA','KICD curriculum','teacher tools','revision','Senior School pathways'],
...
export const metadata: Metadata = {
  ...
  keywords:['VibeSchool','Kenya education','education operating system Kenya','CBC learning','CBE Kenya','KCSE revision','KJSEA','KPSEA','KICD curriculum','Senior School pathways Kenya','school discovery Kenya','teacher tools Kenya'],
