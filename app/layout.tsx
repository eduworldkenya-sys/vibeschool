...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: 'https://www.vibeschool.co.ke/pwa-icons/v2/512', width: 512, height: 512, alt: 'VibeSchool' }],
  },
  twitter: { card: 'summary', title: 'VibeSchool — Learning, teaching and education, connected', description: 'A connected education experience for learners, teachers, parents and schools, with curriculum-aligned learning resources.', images: ['https://www.vibeschool.co.ke/pwa-icons/v2/512'] },
  manifest: '/manifest.webmanifest',
  appleWebApp: { capable: true, statusBarStyle: 'black-translucent', title: 'VibeSchool' },
  icons: {
    icon: [{ url: '/pwa-icons/v2/192', type: 'image/png', sizes: '192x192' }],
