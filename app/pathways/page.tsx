...
export default function PathwaysPage() {
  return <main style={S.root}><div style={S.shell}>
    <header style={S.header}>
      <Link href="/" aria-label="VibeSchool home" style={S.brand}><Image src="/icons/vibeschool-logo.png" alt="VibeSchool" width={460} height={120} priority style={S.logo} /></Link>
      <nav aria-label="Primary" style={S.nav}>
        <Link href="/pathways" style={S.navActive}>Pathways</Link><Link href="/global" style={S.navLink}>Learn</Link><Link href="/about" style={S.navLink}>About</Link><Link href="/contact" style={S.navLink}>Contact</Link><Link href="/login/global?redirect=/pathways" style={S.signIn}>Sign in</Link>
      </nav>
    </header>
