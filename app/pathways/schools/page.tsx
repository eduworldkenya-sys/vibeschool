...
export default function PathwaysSchoolsPage(){
  ...
  return <main style={S.root}><div style={S.shell}>
    ...
    <p style={S.lead}>Search canonical VibeSchool school records. When you filter by a pathway, results only include schools whose pathway offering has been verified.</p>

    <form onSubmit={submit} style={S.form} aria-label="Search verified senior schools">
      <label style={S.field}><span style={S.label}>School</span><input value={query} onChange={e=>setQuery(e.target.value)} placeholder="e.g. Alliance High School" style={S.input}/></label>
