  ...
  return (
    <div style={{
      ...
      <main style={{
        ...
        maxWidth:  "900px",
        margin:    "0 auto",
        background: pathname.startsWith("/admin/finance") || pathname.startsWith("/admin/visitors") ? "#0a1628" : "transparent",
        minHeight:  pathname.startsWith("/admin/finance") || pathname.startsWith("/admin/visitors") ? "100vh" : "auto",
      }}>
        {children}
      </main>
