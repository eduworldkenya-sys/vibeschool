            ...
            <div style={{ background: card, border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "20px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "16px" }}>
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontSize: "28px", fontWeight: "800", color: summary.collectionRate >= 80 ? accent : summary.collectionRate >= 50 ? amber : red, lineHeight: 1 }}>
              ...
              <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: "99px", height: "10px", marginBottom: "12px", overflow: "hidden" }}>
                <div style={{
                  width: `${Math.min(100, summary.collectionRate)}%`, height: "100%",
                  borderRadius: "99px", transition: "width 0.8s ease",
                  background: summary.collectionRate >= 80
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                {accounts.map(acc => (
                  <div key={acc.id} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 16px", background: surface, borderRadius: "12px", border: "1px solid rgba(255,255,255,0.08)" }}>
                    ...
                    <div style={{ fontSize: "16px", fontWeight: "800", color: Number(acc.current_balance) >= 0 ? accent : red }}>
          ...
          <div style={{ background: card, border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", overflow: "hidden" }}>
            {loading ? (
              ...
              <div style={{ textAlign: "center", padding: "56px 20px" }}>
                ...
                <button onClick={() => setShowPayModal(true)} style={{ marginTop: "12px", padding: "10px 20px", borderRadius: "10px", border: "none", background: accent, color: white, fontSize: "13px", fontWeight: "700", cursor: "pointer" }}>
          ...
          <div style={{ background: card, border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", overflow: "hidden" }}>
            {loading ? (
              ...
              <div style={{ textAlign: "center", padding: "56px 20px" }}>
                ...
                <button onClick={() => setShowExpModal(true)} style={{ marginTop: "12px", padding: "10px 20px", borderRadius: "10px", border: "none", background: red, color: white, fontSize: "13px", fontWeight: "700", cursor: "pointer" }}>
