...
export default function Select() {
  ...
  function handleCrestKeyDown(e: React.KeyboardEvent) {
  ...
  function handleAcademyKeyDown(e: React.KeyboardEvent) {
    if (e.key === 'Enter' || e.key === ' ') {
      e.preventDefault()
      fadeOut('/academy/signin')
    }
  }
    ...
    <>
      ...
      <div id="select-root">
        ...
        <div className={styles.content} ref={contentRef}>
          ...
          {/* Crest — tap target wrapper */}
          <div
            className={styles.crestWrapper}
            role="button"
            tabIndex={0}
          ...
          >
            ...
            >
              <path
                d="M36,4 L68,16 L68,52 Q68,76 36,82 Q4,76 4,52 L4,16 Z"
                fill="none"
                stroke="#C8A84B"
                strokeWidth="1.2"
              ...
              />
              <path
                d="M36,10.76 L63.44,21.32 L63.44,52 Q63.44,72.52 36,77.64 Q8.56,72.52 8.56,52 L8.56,21.32 Z"
                fill="none"
                stroke="#C8A84B"
                strokeWidth="1.2"
                strokeLinejoin="round"
          ...
          <div className={styles.cards}>
            ...
            {/* Academy */}
            <div
              className={`${styles.card} ${styles.cardAcademy}`}
              role="button"
              tabIndex={0}
              aria-label="Enter Academy — for schools, teachers and institutions"
              onClick={() => fadeOut('/academy/signin')}
              onKeyDown={handleAcademyKeyDown}
            >
            ...
            >
              ...
              <div className={styles.cardBody}>
                ...
                <p className={styles.cardDescriptor}>
                  For international networks and independent learners.
                </p>
              </div>
