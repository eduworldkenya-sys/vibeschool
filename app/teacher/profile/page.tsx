  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Your legal identity and contact details"
      />
      ...
      <SubSection title="Home Address">
        <FieldGrid>
          ...
          <Field
            ...
            value="P.O. Box 41872-00100, Nairobi"
            span
          />
        </FieldGrid>
      </SubSection>
      <SubSection title="Emergency Contact">
        <FieldGrid>
          ...
          <Field
            label="Address"
            value="Mountain View Estate, Nairobi"
            span
          />
        </FieldGrid>
      </SubSection>
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Employment, designation, and teaching assignment"
      />
      ...
      <SubSection title="Designation and Role">
        <FieldGrid>
          ...
          <Field
            ...
            value="Subject Teacher · Games Mistress"
            span
          />
...
function QualificationsSection() {
  const quals = [
    ...
    {
      name: "CBC Curriculum Orientation",
      institution: "KICD",
      years: "2020",
      grade: "Pass",
      verified: true,
  ...
  const certs = [
    {
      name: "TSC Certificate of Registration",
      number: "TSC-0041-8821",
      expiry: "Dec 2027",
      status: "valid",
    },
    {
      name: "TSC Practicing Certificate",
      number: "PC-2024-0041",
      expiry: "Jun 2026",
      status: "expiring",
    },
    ...
    {
      name: "CBC Training Certificate",
      number: "KICD-2020-1139",
      expiry: "—",
      status: "valid",
    },
  ];
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Formal education, specialisms, and professional certificates"
      />
      ...
      <SubSection title="Teaching Specialisms">
        <FieldGrid>
          ...
          <Field
            label="Age Group"
            value="Upper Primary · Junior Secondary"
          />
  ...
  const pdEntries = [
    {
      ...
      hours: 8,
      date: "Mar 2026",
      topics: ["CBC", "Assessment"],
      takeaway:
        "Aligned my continuous assessment with CBC competency framework",
    },
    {
      title: "Differentiated Instruction — Online",
      type: "Online course",
      provider: "Coursera",
      hours: 14,
      date: "Jan 2026",
      topics: ["Differentiation", "Inclusion"],
      takeaway: "Now using tiered tasks in Grade 7 Mathematics",
    },
  ];
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Training history, PD progress, and appraisal record"
      />
      <SubSection title="PD Hours Progress">
        <div className="p-5 rounded-2xl bg-white/4 border border-white/8 mb-4">
          ...
          <div className="w-full bg-white/10 rounded-full h-3 mb-2">
            <div
              className="h-3 rounded-full bg-gradient-to-r from-[#00E5A0] to-[#00B8FF]"
              style={{ width: "55%" }}
            />
          </div>
          <p className="text-white/40 text-xs">
            18 hours remaining · on track if 1 workshop/month attended
          </p>
        </div>
      </SubSection>
          ...
          {pdEntries.map((entry) => (
            ...
            >
              ...
              <p className="text-white/40 text-xs mb-2">
                {entry.type} · {entry.provider} · {entry.hours} hrs
              </p>
              <div className="flex flex-wrap gap-1.5 mb-2">
                {entry.topics.map((t) => (
                  <span
                    key={t}
                    className="px-2 py-0.5 rounded-full bg-[#00B8FF]/10 border border-[#00B8FF]/20 text-[#00B8FF] text-xs"
                  >
                    {t}
                  </span>
                ))}
...
function TeachingStyleSection() {
  return (
    <div>
      <SectionHeader
        title="Teaching Style & Twin Profile"
        sub="Your preferences and what Twin has observed — private to you"
      />
      <SubSection title="Your Preferences">
        <FieldGrid>
          ...
          <Field
            ...
            value="Written + Practical (Mixed)"
          />
          <Field label="Preferred Grouping" value="Small groups + Mixed" />
          <Field
            label="Preferred Resources"
            value="Realia + Teacher-made"
          />
          <Field label="Easiest to Teach" value="Science Practicals" />
          <Field
            label="Most Challenging"
            value="Number Strand (Grade 6)"
          />
          <Field
            label="Topics I Find Difficult"
            value="Fractions and Decimals, Grade 6"
            span
          />
          <Field
            label="My Goal This Term"
            value="Improve lesson timing accuracy in development phase"
            span
          />
          <Field
            label="Support I Would Like"
            value="Peer observation + Twin assistance"
            span
          />
        </FieldGrid>
      </SubSection>
      <SubSection title="Twin-Observed Profile">
        <div className="p-5 rounded-2xl bg-gradient-to-br from-[#00E5A0]/5 to-[#00B8FF]/5 border border-[#00E5A0]/15 mb-4">
          <p className="text-white/70 text-sm leading-relaxed italic">
            "Mrs. Chebet is a consistent planner who prepares 91% of lessons
            before delivery. She favors group work and realia-based
            activities, which her reflections consistently rate highly. Her
            timing runs slightly long in development phases. Twin recommends
            a short PD input on Number strand pedagogy and has adjusted
            future lesson plan suggestions to front-load visual resources for
            Number topics."
          </p>
        </div>
        <FieldGrid>
          ...
          <Field
            label="Avg Assessment Turnaround"
            value="2.3 days"
          />
          <Field label="Strongest Delivery" value="Science Practicals" />
          <Field label="Weakest Delivery" value="Number Strand" />
          <Field
            label="Highest Rated Conditions"
            value="Practical and group-based lessons"
            span
          />
          <Field
            label="Common Reflection Themes"
            value="Group work · Timing · Realia · Number strand"
            span
          />
        </FieldGrid>
      </SubSection>
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Daily attendance record and leave management"
      />
            ...
            >
              ...
              <div className="w-full bg-white/10 rounded-full h-1.5">
                <div
                  ...
                  style={{
                    width: `${(leave.used / leave.entitlement) * 100}%`,
                  }}
                />
              </div>
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="TSC appraisal cycle and performance signals"
      />
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            },
            {
              label: "HOD Review",
              status: "waiting",
              note: "Awaiting your submission",
            },
            {
              label: "Principal Moderation",
              status: "waiting",
              note: "",
            },
            {
              label: "Submitted to TSC",
              status: "waiting",
              note: "",
            },
          ].map((step) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                {step.note && (
                  <p className="text-white/30 text-xs mt-0.5">{step.note}</p>
                )}
              </div>
            </div>
          ))}
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Internal messages, parent comms, and notification settings"
      />
      <div className="flex items-center justify-center h-40 rounded-2xl bg-white/3 border border-white/8 border-dashed">
        <div className="text-center">
          ...
          <p className="text-white/20 text-xs mt-1">
            Linked to FamilyLayer and school messaging
          </p>
        </div>
      </div>
    </div>
...
function DocumentsSection() {
  const docs = [
    ...
    {
      name: "CBC Orientation Certificate",
      status: "missing",
      expiry: null,
      uploaded: false,
    },
    {
      name: "Child Protection Acknowledgement",
      status: "valid",
      expiry: null,
      uploaded: true,
    },
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="All required documents — upload, track expiry, stay compliant"
      />
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="text-center p-4 rounded-xl bg-[#00E5A0]/10 border border-[#00E5A0]/20">
          <p className="text-[#00E5A0] text-2xl font-bold">
        ...
        <div className="text-center p-4 rounded-xl bg-[#FF4D6A]/10 border border-[#FF4D6A]/20">
          <p className="text-[#FF4D6A] text-2xl font-bold">
            {
              docs.filter(
      ...
      <div className="space-y-2">
        {docs.map((doc) => {
          ...
          return (
            <div
              key={doc.name}
              className="flex items-center justify-between p-3.5 rounded-xl bg-white/3 border border-white/8 hover:border-white/15 transition-colors"
            >
  ...
  return (
    <div>
      <SectionHeader
        ...
        sub="Payroll reference — managed in Finance module"
      />
      ...
      <div className="mt-4 p-4 rounded-xl bg-white/4 border border-white/8 text-center">
        <p className="text-white/40 text-sm">
          Payslip history is managed in the Finance module
        </p>
        <a
          href="/finance/payslips"
          className="text-[#00B8FF] text-sm hover:underline mt-1 block"
        >
