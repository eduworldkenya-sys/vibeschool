      ...
      <div style={{ background: 'linear-gradient(135deg, #0f766e 0%, #14b8a6 100%)', padding: '20px 16px 28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <button
            ...
            style={{ padding: '8px 16px', borderRadius: 10, border: 'none', background: showForm ? 'rgba(255,255,255,0.2)' : '#fff', color: showForm ? '#fff' : '#0f766e', fontWeight: 700, fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' }}
          >
            {showForm ? 'Cancel' : '+ New'}
          </button>
        </div>
        ...
        {showForm && (
          <div style={{ background: '#fff', borderRadius: 20, padding: '20px', marginBottom: 16, boxShadow: '0 1px 4px rgba(0,0,0,0.06)', animation: 'slideDown 0.2s ease' }}>
            ...
            <button
              ...
              disabled={saving}
              style={{ marginTop: 16, width: '100%', padding: '12px', borderRadius: 12, border: 'none', background: saving ? '#99f6e4' : '#0f766e', color: '#fff', fontWeight: 700, fontSize: 14, cursor: saving ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}
            >
        ...
        {loading ? (
          ...
          <div style={{ background: '#fff', borderRadius: 20, padding: '32px 20px', textAlign: 'center', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
            ...
            <p style={{ fontSize: 13, color: C.textMuted, margin: '0 0 20px', lineHeight: 1.5 }}>
              Post your first assignment — parents and students will see it instantly in their portal.
            </p>
            <button
              onClick={() => setShowForm(true)}
              style={{ padding: '10px 24px', borderRadius: 12, border: 'none', background: '#0f766e', color: '#fff', fontWeight: 700, fontSize: 13, cursor: 'pointer', fontFamily: 'inherit' }}
            >
