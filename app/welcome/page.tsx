...
const roles = [
  { title: 'I am a learner', text: 'Find learning resources, practise, understand your work and know what to focus on next.', href: '/student/resources' },
  { title: 'I am a teacher', text: 'Plan, teach, organise your work and use evidence to understand what your learners need next.', href: '/teacher' },
  { title: 'I am a parent', text: 'Get a clearer view of your child’s learning and build a stronger connection between home and school.', href: '/parent' },
  { title: 'I run a school', text: 'Bring people, curriculum, learning activity and school operations into a more connected experience.', href: '/admin' },
]
  ...
  return (
    <main className="welcome">
      <header className="nav">
        <Link href="/welcome" className="brand">Vibe<span>School</span></Link>
        <nav>
      ...
      <section className="hero">
        ...
        <div className="actions">
          <Link href="/" className="primary">Get started</Link>
          <Link href="#find-your-place" className="secondary">Find my place</Link>
        </div>
      ...
      <section id="find-your-place" className="roles">
        ...
        <div className="role-grid">
          {roles.map(role => <article key={role.title}><h3>{role.title}</h3><p>{role.text}</p><Link href={role.href}>See your experience →</Link></article>)}
        </div>
      </section>
      ...
      <section className="cta">
        ...
        <p>Explore first. Create an account when you are ready.</p>
        <div className="actions"><Link href="/" className="primary dark-button">Get started</Link><Link href="/about" className="secondary dark-outline">About VibeSchool</Link></div>
      </section>

      <footer><span>© VibeSchool</span><div><Link href="/welcome">Home</Link><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/legal/privacy">Privacy</Link><Link href="/legal/terms">Terms</Link></div></footer>
