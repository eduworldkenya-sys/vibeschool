...
TBL-003| P0| VERIFIED| Correct pending migration handling| Pending migrations are declared and excluded from false parity failures
...
TBL-011| P0| VERIFIED| Run isolated clean rebuild| Full migration chain succeeds from blank state
