...
Reference points for this contract include Kenya Office of the Data Protection Commissioner guidance for education, children, consent, research and DPIAs; implementation guidance from the Education Endowment Foundation; and monitoring/evaluation principles from UNESCO. These references guide the measurement and publication boundary but do not substitute for legal review or a school-specific privacy assessment.
