...
def main():
 ...
 forbid(page,'"use client"',"server-rendered reader route")
 for v in ["get_public_vibetextbook_reader","generateMetadata","alternates:{canonical}","openGraph","initialPayload"]: require(page,v,"server-rendered reader SEO")
