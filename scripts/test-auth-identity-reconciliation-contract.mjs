...
requireText('legacy observability guard', policyMigration, "to_regclass('public.signup_provisioning_failures') is not null")
requireText('legacy observability guard', policyMigration, 'drop policy if exists signup_provisioning_failures_staff_select')
requireText('legacy observability guard', policyMigration, 'create policy signup_provisioning_failures_staff_select')
