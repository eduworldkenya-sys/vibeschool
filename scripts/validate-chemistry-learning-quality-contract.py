...
required = [
    ...
    "worked_examples_present_where_required",
    "learner_activities_executable",
    "guided_practice_present",
    "misconceptions_addressed",
    "assessment_alignment_complete",
    "teacher_support_complete",
    "scientific_accuracy_checked",
    "kenyan_classroom_feasibility_checked",
...
for forbidden in [
    ...
    if forbidden in text:
        raise SystemExit(f'Forbidden activation/lifecycle/authority mutation detected: {forbidden}')
...
if min(bind_pos, pass_pos) < 0 or bind_pos > pass_pos:
    raise SystemExit('Learning contract must bind stage input before PASS enforcement')
