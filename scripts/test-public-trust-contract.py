...
for fragment in ['THE VIBESCHOOL DIFFERENCE','EXPLORE VIBESCHOOL','FOR SCHOOLS & EDUCATION INSTITUTIONS','Curriculum','Pathways','Trust Centre','/product','/institutions']:
    if fragment not in home: errors.append(f'homepage communication missing: {fragment}')

product = text('app/product/page.tsx')
for fragment in ['THE VIBESCHOOL PRODUCT','THE CONNECTED LEARNING CHAIN','TEACHERS','LEARNERS','PARENTS','SCHOOLS','PRODUCT PROOF, WITHOUT FABRICATED CLAIMS','/institutions','/pathways']:
...
for fragment in ['VIBESCHOOL FOR SCHOOLS','WHAT A SCHOOL CAN BRING TOGETHER','IMPLEMENTATION PRINCIPLE','BEFORE ADOPTION','/trust']:
...
print('Purpose, product proof, trust, governance, legal consistency, SEO, measurement, resilience and public-shell invariants are present.')
