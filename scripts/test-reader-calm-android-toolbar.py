...
if '"use client"' in PAGE: raise AssertionError("reader route regressed to client-only rendering")
if 'get_public_vibetextbook_reader' not in PAGE: raise AssertionError("reader route no longer server-loads public content")
