...
const required = [
  ...
  'docs/CYBORG_OPERATING_CONSTITUTION.md','supabase/migrations/20260822205500_cyborg_mission_kernel.sql',
...
const invariants = [
  ...
  'acquireLease','completion_rejected','completion_accuracy','mission replay must be deterministic'
];
