...
spec=importlib.util.spec_from_file_location('recovery',SCRIPT); assert spec and spec.loader
r=importlib.util.module_from_spec(spec); spec.loader.exec_module(r)


def main()->None:
    with tempfile.TemporaryDirectory() as tmp:
        root=Path(tmp); mig=root/'migrations'; mig.mkdir()
        required=r.REQUIRED_FOUNDATIONS|r.REQUIRED_CLOSURE|{r.PARITY_BRIDGE}
        extra={'20260815124000','20260815125000','20260815130100','20260815130200','20260815131500','20260815132500','20260815133500','20260815141000','20260818112100','20260818112200','20260818112300','20260818112400','20260818112500','20260818112600','20260818112700','20260818112800','20260818112900'}
        expected=required|extra
        for v in expected: (mig/f'{v}_worker_engine_fixture.sql').write_text('-- fixture\n')
