...
create temporary table r13x_candidate as select id from public.hq_workforce_shadow_candidates where source_work_item_id=:'work_id';

do $$ declare cid uuid; rr jsonb; chosen text; oid uuid; pid uuid; v jsonb; begin
 select id into cid from r13x_candidate limit 1;
