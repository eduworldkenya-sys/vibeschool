...
select 'test.quality.inspect',1,id,0,0,array['global'],array['internal'],1,2,30000,true,true,'manual_review','platform_governance','certified',clock_timestamp(),'test','{}','{}','[]','{}','{}','{}','{}','{}',true,'test.quality.inspect@1' from public.hq_workforce_tool_contracts where tool_key='test-r13x-certified-tool'
union all
select 'test.quality.draft',1,id,0,0,array['global'],array['internal'],1,2,30000,true,true,'manual_review','platform_governance','draft',null,'test','{}','{}','[]','{}','{}','{}','{}','{}',true,'test.quality.draft@1' from public.hq_workforce_tool_contracts where tool_key='test-r13x-draft-tool';
