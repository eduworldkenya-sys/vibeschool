...
declare d text;
begin
  if to_regprocedure('public.hq_autopilot_constitution_snapshot()') is null or to_regprocedure('public.hq_autopilot_founder_brief()') is null then raise exception 'autopilot_read_model_missing'; end if;
  if has_function_privilege('service_role','public.hq_autopilot_constitution_snapshot()','EXECUTE') or has_function_privilege('service_role','public.hq_autopilot_founder_brief()','EXECUTE') then raise exception 'service_role_can_impersonate_founder_read_model'; end if;
