...
-- profiles.school_id is legacy compatibility state for teacher surfaces, not
-- authorization. Keep it aligned only through the membership-checked active
-- school setter so older teacher code cannot drift from the canonical context.
