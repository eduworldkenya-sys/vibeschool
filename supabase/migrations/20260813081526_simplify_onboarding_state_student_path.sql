-- Keep onboarding role resolution SECURITY INVOKER (the PostgreSQL default).
-- Student onboarding is intentionally terminal: authenticated students go directly to /student.
