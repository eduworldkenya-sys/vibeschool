...
-- Topic 24.0.0 World Wars is expanded separately. Topics 25-32 are intentionally
-- index-only shells: exact subtopics/objectives must be materialized only after
-- their canonical authority transcription is reviewed.
