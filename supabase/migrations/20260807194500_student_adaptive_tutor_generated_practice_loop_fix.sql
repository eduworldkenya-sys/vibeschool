...
begin
  ...
  if v_outcome_id is null then
    ...
    select c.subject_id into v_subject_id from public.curriculum_learning_outcomes o left join public.curricula c on c.id=o.curriculum_id where o.id=v_outcome_id;
  end if;
