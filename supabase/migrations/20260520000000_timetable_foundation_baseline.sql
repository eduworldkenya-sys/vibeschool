...
create table if not exists public.teacher_classes (
  ...
  class_id uuid not null constraint fk_teacher_classes_class references public.classes(id) on delete restrict,
...
create table if not exists public.timetable_slots (
  ...
  school_id uuid not null references public.schools(id) on delete cascade,
  teacher_id uuid not null references public.profiles(id) on delete cascade,
  class_id uuid not null constraint fk_timetable_slots_class references public.classes(id) on delete restrict,
  subject_id uuid not null references public.subjects(id) on delete restrict,
