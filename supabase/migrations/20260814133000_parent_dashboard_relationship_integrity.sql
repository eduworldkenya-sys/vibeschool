...
-- Keep the parent dashboard relationship-aware and deterministic.
-- parent_student_links is the canonical relationship table; duplicate historical
-- links must not duplicate children or create conflicting dashboard states.
...
'Parent-scoped dashboard projection. Uses canonical parent_student_links, deduplicates historical links, excludes deleted children from attention, and never treats missing evidence as positive evidence.';
