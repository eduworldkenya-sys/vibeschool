...
-- This security hardening migration originally targeted a mixture of tracked
-- and pre-tracked legacy tables. On a clean rebuild, harden every target that
-- exists; do not recreate absent legacy product tables solely to satisfy DDL.
do $rls$
begin
