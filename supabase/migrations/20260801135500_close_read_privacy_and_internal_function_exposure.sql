...
do $policy$
begin
  -- Duplicate historical privacy-hardening step. Apply only when the legacy
  -- product tables and all referenced dependencies exist in the rebuilt
  -- schema; do not manufacture absent pre-tracked objects.
