...
-- access: service-only public.hq_workforce_contracts
-- authorization-test: public.hq_workforce_contracts denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_blueprints
-- authorization-test: public.hq_workforce_blueprints denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_creation_contracts
-- authorization-test: public.hq_workforce_creation_contracts denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_lifecycle_events
-- authorization-test: public.hq_workforce_lifecycle_events denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_identities
-- authorization-test: public.hq_workforce_identities denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_capability_grants
-- authorization-test: public.hq_workforce_capability_grants denies anon/authenticated direct access; service_role retains CRUD.
-- access: service-only public.hq_workforce_execution_budgets
-- authorization-test: public.hq_workforce_execution_budgets denies anon/authenticated direct access; service_role retains CRUD.
...
revoke all on table public.hq_workforce_contracts from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_blueprints from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_creation_contracts from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_lifecycle_events from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_identities from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_capability_grants from public,anon,authenticated,service_role;
revoke all on table public.hq_workforce_execution_budgets from public,anon,authenticated,service_role;
