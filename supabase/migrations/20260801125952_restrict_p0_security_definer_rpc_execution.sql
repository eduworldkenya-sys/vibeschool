...
alter function public.admin_add_student(text, text, text, text, uuid, uuid) set search_path = public, pg_temp;
alter function public.teacher_add_student(text, text, uuid, uuid) set search_path = public, pg_temp;
alter function public.create_child_for_parent(text, date, uuid) set search_path = public, pg_temp;
...
alter function public.purchase_credits(uuid, integer, text) set search_path = public, pg_temp;
alter function public.purchase_credits(uuid, uuid, text) set search_path = public, pg_temp;
alter function public.spend_credit(uuid, text, integer, text) set search_path = public, pg_temp;
alter function public.fn_nightly_maintenance() set search_path = public, pg_temp;
alter function public.fn_write_health_log(uuid, text, text, integer, text, text, numeric) set search_path = public, pg_temp;
