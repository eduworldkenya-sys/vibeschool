...
-- Schema/contract only. Worker qualification/lifecycle eligibility remains owned by
-- the canonical Author/Quality runtime contract already merged on main.
...
begin
  if new.state='SUCCEEDED' and new.output_packet->>'disposition'='PASS' then
