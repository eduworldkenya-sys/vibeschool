...
-- Schema/contract only: production worker lifecycle convergence is isolated in
-- 20260823201400_chemistry_author_quality_runtime_repair.sql and is data-tolerant.
