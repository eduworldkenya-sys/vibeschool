-- Replay-safe finalization for TBL-006.
-- Earlier migrations were applied concurrently in production. This later migration
-- intentionally reasserts the final function definitions so a clean migration
-- replay ends in the same secure, revision-safe state as production.
