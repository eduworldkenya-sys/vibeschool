-- Align onboarding resolver destinations with routes that actually exist in the application.
-- Parent users without linked children should land on the child-management surface,
-- and admins without a school should land on the admin hub rather than a nonexistent
-- onboarding route.
